...
public class P04_Characters_1 { //inner Class
	String name;
	int age;
	double ofP, deP;
	
	public P04_Characters_1(String name) {
		this(name, 260, 35.5, 42.1);
	}
	
	public P04_Characters_1(String name, double ofP) {
		this(name, 1213, ofP, 38.9);
	}
	public P04_Characters_1 (String name, int age, double ofP, double deP) {
		this.name = name;
		this.age = age;
		this.ofP = ofP;
		this.deP = deP;
