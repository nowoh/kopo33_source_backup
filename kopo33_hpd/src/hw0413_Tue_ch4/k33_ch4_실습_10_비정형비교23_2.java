...
public class k33_ch4_실습_10_비정형비교23_2 {
	/*
	 * 비정형비교2_3
	 */
	public static void main(String[] args) {
		for (int k33_i = 1; k33_i < 13; k33_i++) {	//반복문 : 정수형 변수 i는 1, i는 13전까지 1씩 증가하며 반복
			...
			for (int k33_j = 1; k33_j < 32; k33_j++) {	//반복문 : 정수형 변수 j는 1, j는 32전까지 1씩 증가하며 반복
				...
				if ((k33_i == 4 || k33_i == 6 || k33_i == 9 || k33_i == 11) && (k33_j == 30)) break;
					//조건문 : i가 4거나 6이거나 9이거나 11이면서 동시에 j가 30이면 break
				if ((k33_i == 2) && (k33_j == 28)) break;	//조건문 : i가 2이면서 동시에 j가 28이면 break
