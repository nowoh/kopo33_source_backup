...
public class k33_ch7_12_data200 {	//별1
	...
	public static void k33_dataSort() {
		Comparator<k33_ch7_12_Class_ArrayList200> k33_bikyeokijun = new Comparator<k33_ch7_12_Class_ArrayList200>() {
			public int compare(k33_ch7_12_Class_ArrayList200 a1, k33_ch7_12_Class_ArrayList200 a2) {
				return (a2.k33_sum() - a1.k33_sum());
			}
		};
	...
	public static void k33_dataSet() {
		for (int k33_i = 0; k33_i < k33_iPerson; k33_i++) {
			...
			k33_ArrayOneRec.add(new k33_ch7_12_Class_ArrayList200(k33_i+1, k33_name, k33_kor, k33_eng, k33_mat));
		}
	}
	...
	public static void k33_ItemPrint(int i) {
		k33_ch7_12_Class_ArrayList200 k33_rec;
		
		k33_rec = k33_ArrayOneRec.get(i);
		System.out.printf("%03d%8s%5d%8d%8d%8d%8.0f\n", k33_rec.k33_student_id(), k33_rec.name(),k33_rec.k33_kor(), k33_rec.k33_eng(), 
