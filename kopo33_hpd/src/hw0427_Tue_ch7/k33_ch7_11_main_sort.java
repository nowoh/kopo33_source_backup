...
public class k33_ch7_11_main_sort {		
	static ArrayList<k33_ch7_11_Class_ArrayList> k33_ArrayOneRec = new ArrayList <k33_ch7_11_Class_ArrayList>();
	...
	public static void k33_dataSort() {									//data를 정렬하는 메소드 dataSort 정의
		Comparator<k33_ch7_11_Class_ArrayList> k33_bikyeokijun = new Comparator<k33_ch7_11_Class_ArrayList>() {	//Comparator클래스 bigyeokijun 선언 및 생성
			public int compare(k33_ch7_11_Class_ArrayList a1, k33_ch7_11_Class_ArrayList a2) {					//ArrayList a1과 a2를 비교
				return (a2.k33_sum() - a1.k33_sum());		//오름차순, 반대로 하면 내림차순
															//a2.sum - a1.sum이 양수값 즉 a2.sum이 큰 경우 해당 필드가 선택됨
				
//				return (String.valueOf(a.kor).compareTo(String.valueOf(a2.kor)));								//String 비교 방법
			}
		};
		Collections.sort(k33_ArrayOneRec, k33_bikyeokijun);				//ArrayOneRec을 bikyeokijun형식에 맞춰 정렬
	}
	...
	public static void k33_dataSet() {									//데이터를 set하는 메소드 dataSet 정의
		for (int k33_i = 0; k33_i < k33_iPerson; k33_i++) {			//반복문 : 정수형 변수 i는 0이고, i는 iPerson전까지 1씩 증가하며 반복
			...
			k33_ArrayOneRec.add(new k33_ch7_11_Class_ArrayList(k33_i, k33_name, k33_kor, k33_eng, k33_mat));
		}																//ArrayOneRec 배열에 k33_ch7_11_Class_ArrayList 클래스의 메소드 (set 함수) 값을 저장
	}
	...
	public static void k33_ItemPrint(int k33_i) {								//Item을 출력 하는 메소드 ItemPrint 정의 (integer를 인자로 받음)
		k33_ch7_11_Class_ArrayList k33_rec;										//Class_ArrayList rec 선언
