...
public class k33_ch7_11_main_sort {		//별2
	...
	public static void k33_dataSort() {
		Comparator<k33_ch7_11_Class_ArrayList> k33_bikyeokijun = new Comparator<k33_ch7_11_Class_ArrayList>() {
			public int compare(k33_ch7_11_Class_ArrayList a1, k33_ch7_11_Class_ArrayList a2) {
				return (a2.k33_sum() - a1.k33_sum());	//오름차순, 반대로 하면 내림차순
				//return (String.valueOf(a.kor).compareTo(String.valueOf(a2.kor)));	//String 비교 방법
			}
		};
		Collections.sort(k33_ArrayOneRec, k33_bikyeokijun);
	}
	...
	public static void k33_ItemPrint(int k33_i) {
		k33_ch7_11_Class_ArrayList k33_rec;
