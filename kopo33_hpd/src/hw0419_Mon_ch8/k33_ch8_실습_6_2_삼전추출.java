...
public class k33_ch8_실습_6_2_삼전추출 {
	...
	public static void main(String[] args) throws IOException {		//메인함수, error 예외 처리 해줌
		...
		File k33_f1 = new File("C:\\Users\\Howon\\Desktop\\howon\\A005930.csv");					//csv파일 File 객체 생성하여 불러오기
		...
		while ((k33_readtxt = k33_br.readLine()) != null) {											//반복문 : readtxt를 한 줄씩 읽어서 null이 아니면 반복
			...
			if(k33_field.length > 2 && k33_field[2].replace("^", "").trim().equals("A005930")) {
																									//조건문 : field 배열의 길이가 2보다 크고 field배열의 [2]번째 요소의
																									//^를 없애고 앞뒤 공백을 없앤 다음 문자열이 A005930과 같으면 true
																									//A005930는 삼성전자 종목 코드
