...
public class k33_ch8_실습_6_3_20150112추출 {
	...
	public static void main(String[] args) throws IOException {		//메인함수, error 예외 처리 해줌
		...
		File k33_f1 = new File("C:\\Users\\Howon\\Desktop\\howon\\20150112.csv");					//csv파일 File 객체 생성하여 불러오기
		...
		while ((k33_readtxt = k33_br.readLine()) != null) {											//반복문 : readtxt를 한 줄씩 읽어서 null이 아니면 반복
			...
			if(k33_field.length > 1 && k33_field[1].replace("^", "").trim().equals("20150112")) {	//조건문 : field 배열의 길이가 2보다 크고 field배열의 [1]번째 요소의
																									//^를 없애고 앞뒤 공백을 없앤 다음 문자열이 20150112와 같으면 true
				 																					//20150112는 2015년 1월 12일에 거래되었다는 것을 의미
