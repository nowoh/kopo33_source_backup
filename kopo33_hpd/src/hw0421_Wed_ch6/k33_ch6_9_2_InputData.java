...
public class k33_ch6_9_2_InputData {	
	...
	float[] k33_avg;			//실수형 배열 avg 전역변수로 정의
	
	k33_ch6_9_2_InputData(int k33_iPerson) {		//인자로 정수형 변수 iPerson을 받는 생성자 정의
	...
	public void k33_SetData(int k33_i, String k33_name, int k33_kor, int k33_eng, int k33_mat) {	
		...
		this.k33_avg[k33_i] = (float) ((k33_kor + k33_eng + k33_mat) / 3.0);	//배열 avg의 i번째 요소를 ((kor + eng + mat) / 3.0)으로 정의
	}
}
