...
public class k33_ch6_9_2_InputData {	//별2
	...
	float[] avg;			//실수형 배열 avg 전역변수로 정의
	
	k33_ch6_9_2_InputData(int iPerson) {	//인자로 정수형 변수 iPerson을 받는 생성자 정의
		...
		avg = new float[iPerson];			//배열 avg의 크기를 iPerson으로 정의
	...
	public void SetData(int i, String name, int kor, int eng, int mat) {	
		...
		this.avg[i] = (float) ((kor + eng + mat) / 3.0);	//배열 avg의 i번째 요소를 ((kor + eng + mat) / 3.0)으로 정의
	}
}
